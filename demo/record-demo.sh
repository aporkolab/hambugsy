...
sleep 1
run_cmd "hambugsy analyze test/fixtures/java"
sleep 4
...
sleep 1
run_cmd "hambugsy analyze test/fixtures/typescript"
sleep 4
...
sleep 1
run_cmd "hambugsy analyze test/fixtures/python"
sleep 4
...
sleep 1
run_cmd "hambugsy analyze test/fixtures/typescript --run-tests"
sleep 4
...
sleep 1
run_cmd "hambugsy suggest test/fixtures/java/OrderService.java"
sleep 4
...
sleep 1
run_cmd "hambugsy analyze test/fixtures/java --format=json | head -50"
sleep 3
...
sleep 1
run_cmd "hambugsy analyze test/fixtures/java --format=markdown | head -40"
sleep 3
...
sleep 1
run_cmd "hambugsy fix test/fixtures --dry-run --yes"
sleep 3
...
sleep 1
run_cmd "hambugsy analyze test/fixtures/java --format=github"
sleep 3
